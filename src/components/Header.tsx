...
export default function Header() {
  ...
  return (
    <header className="w-auto bg-white dark:bg-dark-card rounded-xl mt-2 sm:mt-3 md:mt-6 mx-2 sm:mx-3 md:mx-6 px-3 sm:px-4 md:px-6 flex items-center justify-between min-h-[48px] sm:min-h-[56px] md:min-h-[64px] border border-gray-200 dark:border-dark-border ml-6">
