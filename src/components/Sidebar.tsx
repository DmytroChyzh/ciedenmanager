...
export default function Sidebar() {
  ...
  return (
    <aside className={`bg-white dark:bg-dark-card rounded-xl h-[calc(100vh-130px)] xs:h-[calc(100vh-130px)] sm:h-[calc(100vh-130px)] md:h-[calc(100vh-130px)] lg:h-[calc(100vh-130px)] flex flex-col transition-all duration-200 ${collapsed ? 'w-10 xs:w-12 sm:w-14 md:w-16' : 'w-full xs:w-[160px] sm:w-[180px] md:w-[200px] lg:w-[220px] xl:w-[240px] 2xl:w-[260px]'} pb-0 ml-1 xs:ml-2 sm:ml-3 md:ml-4 lg:ml-5 xl:ml-6 mt-1 xs:mt-2 sm:mt-3 md:mt-4 lg:mt-5 xl:mt-6`}>
      ...
      <div className={`p-2 ${collapsed ? 'flex justify-center' : ''}`}>
        <button 
          onClick={logout}
          className={`flex items-center ${collapsed ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-lg ${collapsed ? 'w-10 h-10' : 'w-full'} text-left transition-all duration-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:ring-offset-2 dark:focus:ring-offset-dark-card hover:bg-red-50 dark:hover:bg-red-900/20 active:bg-red-100 dark:active:bg-red-800/30 text-gray-700 dark:text-dark-text-muted hover:text-red-700 dark:hover:text-red-400`}
        >
          <span className={`flex items-center justify-center ${collapsed ? 'w-5 h-5' : 'w-5 h-5'}`}>
