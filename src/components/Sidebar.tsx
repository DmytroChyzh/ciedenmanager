...
export default function Sidebar() {
  ...
  return (
    <aside className={`bg-white dark:bg-dark-card rounded-xl h-[1600px] flex flex-col border border-gray-200 dark:border-dark-border transition-all duration-200 ${collapsed ? 'w-16' : 'w-full md:w-[240px] lg:w-[280px]'} pb-4 ml-8 mt-8`}>
      {/* Hamburger кнопка */}
      <button
